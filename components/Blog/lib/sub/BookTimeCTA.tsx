    ...
    <div className="pb-10">
      <div className=" mt-8 p-6 text-center">
        ...
        <div className="flex justify-center">
          <Link
            href="/get-in-touch"
            className="mt-3 block w-64 rounded-lg bg-gradient-to-r from-sky-500 to-sky-800 px-4 py-2 text-center text-white transition-colors duration-200 hover:brightness-110"
          >
            Book an appointment
          </Link>
        </div>
