  ...
  const shareToSocial = () => {
    ...
    switch (currentPlatform) {
      ...
      case "behance":
        ...
        break;
      case "instagram":
        // Instagram does not support direct link sharing; redirect to Instagram homepage
  ...
  return (
    <>
      <div className="mt-11 flex flex-wrap gap-4 md:items-center md:justify-between md:gap-0">
        <ul className="flex w-full flex-wrap items-center justify-center gap-3 md:justify-normal md:gap-6">
          <li>
          ...
          <li>
            <a
              ...
              className="group"
            >
              <div className="flex h-10 w-10 items-center justify-center rounded-full bg-gray-100 transition-all duration-300 group-hover:scale-110 group-hover:bg-pink-500">
                <svg
                  className="h-5 w-5 fill-gray-600 transition-colors duration-300 group-hover:fill-white"
                  viewBox="0 0 24 24"
                  xmlns="http://www.w3.org/2000/svg"
