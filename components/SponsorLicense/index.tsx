...
// components/SponsorLicenceSection.tsx
...
const SponsorLicenceSection: React.FC = () => {
  ...
  const ListItem: React.FC<ListItemProps> = ({ content }) => (
    <li className="text-muted-foreground group mb-5 flex gap-4 md:mb-4 lg:items-center">
      <svg
        className="shrink-0"
      ...
      <p className="group-hover:text-foreground select-none text-sm font-semibold transition-all duration-300 group-hover:translate-x-2 md:text-base lg:text-lg lg:font-bold">
        {content}
      </p>
    </li>
  );
  ...
  return (
    <section className="grid place-items-center py-20">
      <div className="container grid gap-10 lg:grid-cols-[0.7fr_1fr] lg:gap-20">
        <div className="flex items-center justify-center lg:justify-start">
          <Image
            src="/images/features/banner-1.svg"
            alt="hero banner"
            width={600}
            height={450}
        ...
        <div className="flex items-center justify-center lg:justify-end">
          <div>
            <h2 className="section-title relative mb-12 lg:mb-14 lg:text-left">
              Why You Need Sponsor Licence?
              <span className="indicator lg:indicator-left lg:w-full lg:after:[animation-duration:7000ms]"></span>
            </h2>
            <ul>
              <ListItem content="Recruit Skilled Workers from Outside UK to fill talent gaps." />
              <ListItem content="Hire Right Talent to drive Innovation and Business Growth." />
              <ListItem content="Support your Business Expansion Plan" />
              <ListItem content="Stay Competitive in your Industry with Highly Skilled Workers" />
              <ListItem content="Allow you to legally employ non-UK workers" />
              <ListItem content="Long term Staff Retention & Peace of Mind" />
            </ul>
          </div>
        </div>
      </div>
