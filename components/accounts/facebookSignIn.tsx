...
export const FacebookSignInButton = ({ type }: { type: string }) => {
  ...
  return (
    <button
      ...
      className="text-body-color mb-6  flex w-full max-w-[350px] items-center justify-center rounded-sm border border-stroke bg-[#f8f8f8] px-6 py-3 text-base outline-none transition-all duration-300 hover:border-primary hover:bg-primary/5 hover:text-primary "
