            ...
            <div className="flex flex-col justify-center p-6 md:w-1/2 md:p-12">
              <AnimatePresence mode="wait">
                ...
                >
                  ...
                  <motion.button
                    className="font-mono md:font-sans rounded-xl bg-[#FFF9EB] px-4 py-2.5 text-sm uppercase tracking-wider text-[#533900] shadow-xl transition-all duration-300 hover:bg-[#1a1a1a] hover:text-white md:px-6 md:py-3"
